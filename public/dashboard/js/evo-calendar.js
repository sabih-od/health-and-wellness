...
(function (factory) {
	...
	EvoCalendar = (function () {
		...
		function EvoCalendar(element, settings) {
			...
			_.$cal_months_labels = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
	...
	EvoCalendar.prototype.buildCalendar = function (val, new_month, new_year) {
		...
		function buildSidebarHTML() {
			sidebarHTML =
				'<div class="calendar-year"><button class="icon-button" year-val="prev" title="Previous year"><span class="chevron-arrow-left"></span></button>&nbsp;<p>' +
				new_year +
				'&nbsp;</p><button class="icon-button" year-val="next" title="Next year"><span class="chevron-arrow-right"></span></button></div>';
	...
	EvoCalendar.prototype.initEventListener = function () {
		...
		if (_.options.sidebarToggler) {
			$('#sidebarToggler').off('click.evocalendar').on('click.evocalendar', _.toggleSidebar);
		}
		if (_.options.eventListToggler) {
			$('#eventListToggler').off('click.evocalendar').on('click.evocalendar', _.toggleEventList);
		}
		if (_.options.canAddEvent) {
			$('#eventAddButton').off('click.evocalendar').on('click.evocalendar', _.options.onAddEvent);
		}

		$('[date-val]').off('click.evocalendar').on('click.evocalendar', _.selectDate).on('click.evocalendar', _.options.onSelectDate);

		// set event listener for each month
		$('[month-val]').off('click.evocalendar').on('click.evocalendar', _.selectMonth);

		// set event listener for year
		$('[year-val]').off('click.evocalendar').on('click.evocalendar', _.selectYear);
	};
