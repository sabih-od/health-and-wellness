                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            ...
                            <form class="service-form" method="post" action="{{ route('admin.edit.faq' , $content->id) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    @if(Session::has('msg'))
...
{{--                                        @enderror--}}
                                        ...
                                        <div class="img-upload full-width-img">
                                            <div id="image-preview" class="img-preview">
                                                <img id="preview-image" src="{{ $content->get_faq_picture() }}" width="150" alt="Image Preview">
                                            </div>
