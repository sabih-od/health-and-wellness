...
@section('title', (isset($content->name) ? $content->name : ''). ' Forum Category')
@section('page_css')
<!-- Datatables -->
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6 offset-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Forum Category Detail</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Forum Category Detail</h3>
                        </div>
