...
{{--                                        </div>--}}
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="tax_rate" class="form-control" step="0.01" value="{{$content->tax_rate ?? 0}}" placeholder="Tax Rate">
                                        </div>
                                        <div class="form-group">
                                              ...
                                              <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                             <input type="radio" name="paypal_env" id="paypal_env_live"  @if($content->paypal_env == "Live") checked @endif value="Live"> Live &nbsp;
                                                            <input type="radio" name="paypal_env" id="paypal_env_testing"  @if($content->paypal_env == "Testing") checked @endif value="Testing"> Testing
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8"><input type="text" name="paypal_client_id" id="paypal_client_id" class="form-control" value="{{$content->paypal_client_id??''}}"></div>
                                                    </div>
                                                    <br/>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-8"><input type="text" name="paypal_secret_key" id="paypal_secret_key"  class="form-control" value="{{$content->paypal_secret_key??''}}" ></div>
                                                    </div>
                                                </div>
                                              </div>
                                            </div>
                                              ...
                                              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                             <input type="radio" name="stripe_env" @if($content->stripe_env == "Live") checked @endif id="" value="Live"> Live &nbsp;
                                                            <input type="radio" name="stripe_env" @if($content->stripe_env == "Testing") checked @endif id="" value="Testing"> Testing
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8"><input type="text" name="stripe_publishable_key"  id="stripe_publishable_key" class="form-control" value="{{$content->stripe_publishable_key??''}}"></div>
                                                    </div>
                                                    <br/>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-8"><input type="text" name="stripe_secret_key" id="stripe_secret_key"  class="form-control" value="{{$content->stripe_secret_key??''}}"></div>
                                                    </div>
                                                </div>
                                              </div>
                                            </div>
