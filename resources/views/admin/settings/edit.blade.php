                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="tax_rate" class="form-control" step="0.01"
                                                       value="{{$content->tax_rate ?? 0}}" placeholder="Tax Rate">
                                            </div>
                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="radio" name="stripe_env"
                                                                               ...
                                                                               @endif id="" value="Live"> Live &nbsp;
                                                                        <input type="radio" name="stripe_env"
                                                                               @if($content->stripe_env == "Testing") checked
                                                                               @endif id="" value="Testing"> Testing
                                                                    </div>
                                                                </div>
                                                                <br>
                                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group-btn">
                                                            <div class="image-upload">
                                                                <img
                                                                    src="{{asset(!empty($content->logo) && file_exists('uploads/settings/'.$content->logo) ? 'uploads/settings/'.$content->logo:'admin/dist/img/placeholder.png')}}"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group-btn">
                                                            <div class="image-upload">
                                                                <img
                                                                    src="{{asset(!empty($content->favicon) && file_exists('uploads/settings/'.$content->favicon) ? 'uploads/settings/'.$content->favicon:'admin/dist/img/placeholder.png')}}"
                                                                    class="img-responsive" width="100px" height="100px">
                                                                <div class="file-btn mt-4">
                                                                    <input type="file" id="favicon" name="favicon"
                                                                           accept=".jpg,.png">
                                                                    <input type="text" id="favicon" name="favicon"
                                                                           value="{{ !empty($content->favicon) ? $content->favicon : '' }}"
                                                                           hidden="">
                                                                </div>
                                                            </div>
                                                        </div>
