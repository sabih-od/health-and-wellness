...
//                        if ($givenDateTime <= $currentDateTime && $givenDateSecondTime >= $currentDateTime) {
                            $joinCallButton = '<a href="admin-stream/'.$data->session->id.'" title="Start Call" type="button" name="join_call" id="' . $data->id . '" class="joincall btn btn-success btn-sm">Start Call</button>&nbsp;';
